...
fun convertApiToModel(movieApi: MovieAPI): Movie {
    val fact: MovieAPI = movieApi!!
    val popularity = fact.popularity ?: "0.0"
    val posterPath = fact.posterPath ?: ""
    val movieModel = Movie(fact.id!!, fact.name!!, posterPath, convertGengeIds(fact.genresIds), "",
        "",popularity,"")
    return movieModel
